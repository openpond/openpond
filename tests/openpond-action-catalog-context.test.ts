...
describe("OpenPond action catalog context", () => {
  ...
  test("adds compact OpenPond capability index before profile skills", async () => {
    ...
    expect(prompt).toContain(
      "- authoring_skills: /skill preloads openpond-skill-authoring, /agent preloads openpond-agent-authoring, and /refiner preloads openpond-refiner-authoring into a normal model turn.",
    );
