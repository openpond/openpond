...
Create-agent and edit-agent Goals use the shared Create/Improve run. Its plan
and workflow capture are durable Goal state under the configured local
...
contains an approved Create/Improve plan, follow that plan, preserve or create a
