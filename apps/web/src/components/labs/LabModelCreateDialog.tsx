      ...
      <form onSubmit={(event) => { void submit(event); }}>
        <fieldset disabled={fieldsLocked} className="model-create-fields">
          {step === 0 ? <>
            ...
            <ModelCreationReward client={learningClient} taskset={selectedTaskset} starter={activeStarter?.preview} bindingRef={draft.rewardBindingRef} onChange={(rewardBindingRef) => patch({ rewardBindingRef })} />
