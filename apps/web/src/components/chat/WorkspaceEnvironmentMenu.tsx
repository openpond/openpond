    ...
    try {
      ...
      const payload = await api.updateLocalProjectAgentSetup(connection, selectedProject.id, {
        linkedSandboxProject: {
          ...
          lastUploadedCommit: selectedProject.linkedSandboxProject?.lastUploadedCommit ?? null,
          lastUploadTransport: selectedProject.linkedSandboxProject?.lastUploadTransport ?? null,
