...
function usageSummary(): UsageSummaryResponse {
  ...
  return {
    ...
    totals: {
      ...
      promptTokens: 48_200,
      cacheTelemetryRequests: 68,
      cacheHitRequests: 52,
      cachedPromptTokens: 32_000,
      uncachedPromptTokens: 16_200,
      cacheWritePromptTokens: null,
      cacheHitRate: 0.6639,
      cacheRequestHitRate: 0.7647,
      cacheTelemetryCoverage: 0.9577,
...
function breakdown(totalTokens: number | null): Omit<UsageSummaryResponse["models"][number], "provider" | "model" | "route"> {
  return {
    ...
    cacheTelemetryRequests: totalTokens === null ? 0 : 12,
    cacheHitRequests: totalTokens === null ? 0 : 9,
    cachedPromptTokens: totalTokens === null ? null : Math.round(totalTokens * 0.48),
    uncachedPromptTokens: totalTokens === null ? null : Math.round(totalTokens * 0.26),
    cacheWritePromptTokens: null,
    cacheHitRate: totalTokens === null ? null : 0.6486,
    cacheRequestHitRate: totalTokens === null ? null : 0.75,
    cacheTelemetryCoverage: totalTokens === null ? 0 : 1,
...
function usageRecord(
  ...
  return {
    ...
    cachedPromptTokens: totalTokens === null ? null : Math.round(totalTokens * 0.5),
    uncachedPromptTokens: totalTokens === null ? null : Math.round(totalTokens * 0.25),
    cacheWritePromptTokens: null,
    cacheTelemetrySource: totalTokens === null ? null : "provider_usage_body",
