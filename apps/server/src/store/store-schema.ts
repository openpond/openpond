export const CURRENT_SQLITE_SCHEMA_VERSION = 57;
...
export const SQLITE_CREATE_SCHEMA_SQL = `
  ...
  CREATE TABLE IF NOT EXISTS model_comparison_series (
    id TEXT PRIMARY KEY,
    profile_id TEXT NOT NULL,
    model_project_id TEXT NOT NULL,
    status TEXT NOT NULL,
    payload TEXT NOT NULL,
    created_at TEXT NOT NULL,
    updated_at TEXT NOT NULL
  );
  CREATE INDEX IF NOT EXISTS model_comparison_series_profile_updated_idx ON model_comparison_series(profile_id, updated_at DESC);
  CREATE INDEX IF NOT EXISTS model_comparison_series_project_updated_idx ON model_comparison_series(model_project_id, updated_at DESC);

  CREATE TABLE IF NOT EXISTS model_comparison_series_entries (
    id TEXT PRIMARY KEY,
  ...
  CREATE TABLE IF NOT EXISTS reward_model_runs (
    id TEXT PRIMARY KEY,
