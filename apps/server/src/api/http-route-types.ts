...
export type HttpRouteDeps = {
  ...
  reviewHarnessEvaluationPayload: (payload: unknown) => Promise<unknown>;
  updateHarnessEvaluationReviewSchedulePayload: (payload: unknown) => Promise<unknown>;
  ...
  profileEvaluationRunSuitePayload: (payload: unknown) => Promise<unknown>;
  profileEvaluationComparePayload: (payload: unknown) => Promise<unknown>;
  profileEvaluationSaveReportPayload: (payload: unknown) => Promise<unknown>;
  ...
  listCreateImproveRunsPayload: (requestUrl: URL) => Promise<unknown>;
  getCreateImproveRunPayload: (runId: string) => Promise<unknown>;
  getCreateImproveCandidateDiffPayload: (
    runId: string,
    candidateId: string
  ) => Promise<unknown>;
