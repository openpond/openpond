...
function normalizeRoutePath(pathValue: string): string {
  const patterns: Array<[RegExp, string]> = [
    ...
    [/^\/v1\/sessions\/[^/]+\/turns\/steer$/, "/v1/sessions/:sessionId/turns/steer"],
    [/^\/v1\/sessions\/[^/]+\/inbox$/, "/v1/sessions/:sessionId/inbox"],
    [/^\/v1\/sessions\/[^/]+\/inbox\/[^/]+$/, "/v1/sessions/:sessionId/inbox/:inputId"],
