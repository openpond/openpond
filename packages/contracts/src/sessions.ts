...
export const SessionSchema = z.object({
  ...
  openPondAccountId: z.string().nullable().optional(),
  openPondWorkspaceId: z.string().nullable().optional(),
  openPondWorkspaceType: z.enum(["personal", "team"]).nullable().optional(),
