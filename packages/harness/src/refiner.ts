  ...
  return [
    {
      ...
      content: [
        ...
        "Valid passing grades do not erase avoidable tool detours, excessive retries, latency, or token cost, but high usage alone does not justify a Harness change. A repeated malformed or avoidable tool strategy can be improvement evidence even when every affected task ultimately passes. Distinguish an agent workflow that belongs in the Harness from a runtime or product defect that should be routed externally.",
